    ...
    <footer className="site-footer">
      <div className="mx-auto w-full max-w-[73.75rem] px-4 py-10 sm:px-6 lg:px-8">
        <div className="footer-columns">
          ...
          <nav aria-label="Downloaders" className="footer-link-column">
            <p className="footer-column-title">Downloaders</p>
            <div className="footer-column-links">
              {platformOrder.map((id) => <Link key={id} href={platformConfigs[id].path}>{platformConfigs[id].name}</Link>)}
            </div>
          </nav>

          <nav aria-label="Legal" className="footer-link-column">
          ...
          <div className="footer-link-column footer-community">
